...
static const _DepthData_type_support_symbol_names_t _DepthData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, entrance_detection_msgs, msg, DepthData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, entrance_detection_msgs, msg, DepthData)),
  }
};
...
{
  return &::entrance_detection_msgs::msg::rosidl_typesupport_cpp::DepthData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, entrance_detection_msgs, msg, DepthData)() {
  return get_message_type_support_handle<entrance_detection_msgs::msg::DepthData>();
}
