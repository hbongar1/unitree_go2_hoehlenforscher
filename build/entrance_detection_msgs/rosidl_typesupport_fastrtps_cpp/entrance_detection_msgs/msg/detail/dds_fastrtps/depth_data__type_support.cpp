...
#include "entrance_detection_msgs/msg/detail/depth_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const entrance_detection_msgs::msg::DepthData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  entrance_detection_msgs::msg::DepthData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = entrance_detection_msgs::msg::DepthData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const entrance_detection_msgs::msg::DepthData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<entrance_detection_msgs::msg::DepthData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DepthData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const entrance_detection_msgs::msg::DepthData *>(
...
static size_t _DepthData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DepthData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DepthData__callbacks = {
...
static rosidl_message_type_support_t _DepthData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DepthData__callbacks,
...
{
  return &entrance_detection_msgs::msg::typesupport_fastrtps_cpp::_DepthData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, entrance_detection_msgs, msg, DepthData)() {
  return &entrance_detection_msgs::msg::typesupport_fastrtps_cpp::_DepthData__handle;
}
