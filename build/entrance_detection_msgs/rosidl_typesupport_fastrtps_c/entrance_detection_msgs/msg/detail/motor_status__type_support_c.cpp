...
#include "entrance_detection_msgs/msg/detail/motor_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // error_message, posture_mode
#include "rosidl_runtime_c/string_functions.h"  // error_message, posture_mode
...
using _MotorStatus__ros_msg_type = entrance_detection_msgs__msg__MotorStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: current_body_height
  {
    cdr << ros_message->current_body_height;
  }

  // Field name: posture_mode
  {
    const rosidl_runtime_c__String * str = &ros_message->posture_mode;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: posture_mode
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->posture_mode.data) {
      rosidl_runtime_c__String__init(&ros_message->posture_mode);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->posture_mode,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'posture_mode'\n");
      return false;
    }
  }
...
size_t get_serialized_size_entrance_detection_msgs__msg__MotorStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorStatus__ros_msg_type * ros_message = static_cast<const _MotorStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MotorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_entrance_detection_msgs__msg__MotorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_entrance_detection_msgs
size_t max_serialized_size_entrance_detection_msgs__msg__MotorStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = entrance_detection_msgs__msg__MotorStatus;
    is_plain =
      (
...
static size_t _MotorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_entrance_detection_msgs__msg__MotorStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, entrance_detection_msgs, msg, MotorStatus)() {
