...
bool entrance_detection_msgs__msg__lidar_gap__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("entrance_detection_msgs.msg._lidar_gap.LidarGap", full_classname_dest, 47) == 0);
  }
  entrance_detection_msgs__msg__LidarGap * ros_message = _ros_message;
  {  // header
  ...
  {  // in_camera_fov
    PyObject * field = PyObject_GetAttrString(_pymsg, "in_camera_fov");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->in_camera_fov = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of LidarGap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("entrance_detection_msgs.msg._lidar_gap");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LidarGap");
  ...
  {  // in_camera_fov
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->in_camera_fov ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "in_camera_fov", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
