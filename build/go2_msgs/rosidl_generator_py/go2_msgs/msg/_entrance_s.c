...
bool go2_msgs__msg__entrance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_msgs.msg._entrance.Entrance", full_classname_dest, 31) == 0);
  }
  go2_msgs__msg__Entrance * ros_message = _ros_message;
  {  // header
...
PyObject * go2_msgs__msg__entrance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_msgs.msg._entrance");
